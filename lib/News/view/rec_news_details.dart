...
class RecNewsDetails extends StatelessWidget {
  const RecNewsDetails({super.key, required this.newsModel});
  final NewsModel newsModel;

  @override
  Widget build(BuildContext context) {
    var dateValue = DateFormat("EEE, dd MMM y HH:mm:ssz").parse(newsModel.pubdate!).toLocal();
