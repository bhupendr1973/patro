...
import 'package:shrayesh_patro/Download_Music/youtube_services.dart';
...
class PlayerInvoke {
  ...
  static void setDownValues(List response, int index) {
    ...
    queue.addAll(
      response.map(
            (song) => downMapToMediaItem(song as Map),
      ),
    );
    updateNplay(queue, index);
  }
...
// pahithapneeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    //queue.addAll(
     // response.map(
          //  (song) => mapToMediaItem(
        //  song as Map,
