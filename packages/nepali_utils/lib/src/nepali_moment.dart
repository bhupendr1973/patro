...
class NepaliMoment {
  ...
  static String _calc(DateTime date, DateTime referenceDate, bool showToday) {
    ...
    if (seconds < 45) {
      ...
      momentString = isEnglish ? 'about an hour' : 'एक घण्टा';
    } else if (hours < 24) {
